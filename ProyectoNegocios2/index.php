		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-6 col-md-4">
					<div class="card mb-4 ">
						<img src="img/milky.jpg" style="padding-top: 15px;" title="pandas" alt="imgpanda" class="cardimg">
						<div class="card-body">
							<ul class="list-unstyled text-left">
								<li>
									<p class="card-text">Para esos 5 minutos de descanso! ahora con un gran descuento en la compra de un MilkyWay Mini de 52 pz</p>
								<li><a href="#" title="referencia"><span class="text-success">Ver descuentos del 10%</span></a></li>
							</ul>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="card mb-4 ">
						<img src="img/img8.jpg" style="padding-top: 15px;" title="imgpantalon" alt="pantalon" class="cardimg">
						<div class="card-body">
							<ul class="list-unstyled text-left">
								<li>
									<p class="card-text">Aun no tiene con que envolver el regalo de mama? tenemos para ti las cajas perfectas para el regalo perfecto </p>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="card mb-4 ">
						<img src="img/img2.jpg" style="padding-top: 15px;" title="cremaparamanos" alt="imcrema" class="cardimg">
						<div class="card-body">
							<ul class="list-unstyled text-left">
								<li>
									<p class="card-text">Complementa tus fotos con esta excelente cortina de fondo!</p>
								<li><a href="#" title="ref"><span class="text-success">Ver descuentos del 15%</span></a></li>
							</ul>
							<div class="d-flex justify-content-between align-items-center">
								<div class="btn-group">
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="card mb-4 ">
						<img src="img/img5.jpg" style="padding-top: 40px;" title="cadena" alt="cadena" class="cardimg">
						<div class="card-body">
							<ul class="list-unstyled text-left">
								<li>
									<p class="card-text">Tenemos los excelentes globos para complementar tu regalo este 10 de mayo!</p>
